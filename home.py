...
def getPage1():
    ...
    tk.Button(btn_grid, text="Select Images", command=lambda: selectMultiImage(opt_menu, menu_var), font="Arial 15 bold", bg="#ff0000",
    ...
    tk.Button(scroll_frame, text="Register", command=lambda: register(entries, required, menu_var), font="Arial 15 bold",
           bg="#ff0000", fg="white", pady=10, padx=30, bd=0, highlightthickness=0, activebackground="#091428",
...
def getPage2():
    ...
    tk.Button(btn_grid, text="Select Image", command=selectImage, font="Arial 15 bold", padx=20, bg="#ff0000",
            fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#091428",
            activeforeground="white").grid(row=0, column=0, padx=25, pady=25)
    tk.Button(btn_grid, text="Recognize", command=startRecognition, font="Arial 15 bold", padx=20, bg="#ff0000",
           fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#091428",
...
######################################## Home Page ####################################
tk.Label(pages[0], text="Crime Suspect Recognition System", fg="white", bg="#202d42",
